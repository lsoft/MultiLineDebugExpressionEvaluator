...
namespace MultiLineDebugExpressionEvaluator
{
    ...
    public static class Logging
    {
        ...
        // Logs go to: C:\Users\<user>\AppData\Local\Temp\MultiLineDebugExpressionEvaluator.log
        // We're using one log file for each process to prevent concurrent file access.
        private static readonly string vsLogFile = $"{Path.GetTempPath()}/MultiLineDebugExpressionEvaluator.log";
